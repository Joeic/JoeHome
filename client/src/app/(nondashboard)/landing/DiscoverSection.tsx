    ...
    <div className='max-w-4xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16'>
        ...
        >
            ...
            <p className=' mt-2 text-gray-500 max-w-3xl mx-auto'>
                Use our user-friendly features to find your perfect home.
            </p>
        </motion.div>
           ...
           {[
            {
                ...
                description: "Browse through our extensive collections of rental properties in your desired location."
            },
            {
                imageSrc: "/landing-icon-calendar.png",
                title: "Book your rental",
                description: "Once you've find the perfect rental property, easily book it online with just a few clicks"
            },
            {
